...
=
  * [BP4D](http://www.cs.binghamton.edu/~lijun/Research/3DFE/3DFE_Analysis.html)
    ...
    *   ```text
        data/BP4D/list/
        ├── data/BP4D/list/BP4D_img_path_fold1.txt
        ├── data/BP4D/list/BP4D_img_path_fold2.txt
        ├── data/BP4D/list/BP4D_img_path_fold3.txt
  ...
  * [DISFA](http://mohammadmahoor.com/disfa-contact-form/)
    ...
    *   ```text
        data/BP4D/list/
        ├── data/DISFA/list/DISFA_img_path_fold1.txt
        ├── data/DISFA/list/DISFA_img_path_fold2.txt
        ├── data/DISFA/list/DISFA_img_path_fold3.txt
...
**You need to unzip three files after downloading** 
```test 
unzip data/BP4D/list/BP4D_train_AU_relation_fold1.zip
unzip data/BP4D/list/BP4D_train_AU_relation_fold2.zip
unzip data/BP4D/list/BP4D_train_AU_relation_fold3.zip
```
