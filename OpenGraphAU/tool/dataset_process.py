...
np.savetxt(
    os.path.join(list_path_prefix, "BP4D_train_label.txt"),
    BP4D_train_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "BP4D_val_label.txt"),
    BP4D_val_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "BP4D_test_label.txt"),
    BP4D_test_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "DISFA_train_label.txt"),
    DISFA_train_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "DISFA_val_label.txt"),
    DISFA_val_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "DISFA_test_label.txt"),
    DISFA_test_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "CK+_train_label.txt"),
    CKPlus_train_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "CK+_val_label.txt"),
    CKPlus_val_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "CK+_test_label.txt"),
    CKPlus_test_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "RAF_AU_train_label.txt"),
    RAF_AU_train_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "RAF_AU_val_label.txt"),
    RAF_AU_val_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "RAF_AU_test_label.txt"),
    RAF_AU_test_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "CASME2_train_label.txt"),
    CASME2_train_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "CASME2_val_label.txt"),
    CASME2_val_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    os.path.join(list_path_prefix, "CASME2_test_label.txt"),
    CASME2_test_image_label,
    fmt="%d",
    delimiter=" ",
)
...
np.savetxt(
    "Datasets/hybrid_dataset/list/hybrid_train_label.txt",
    new_dataset_train_label_list,
    fmt="%d",
    delimiter=" ",
)
np.savetxt(
    "Datasets/hybrid_dataset/list/hybrid_val_label.txt",
    new_dataset_val_label_list,
    fmt="%d",
    delimiter=" ",
)
np.savetxt(
    "Datasets/hybrid_dataset/list/hybrid_test_label.txt",
    new_dataset_test_label_list,
    fmt="%d",
    delimiter=" ",
)
